...
class LLMParser():
    ...
    def JSON_response(self, user_prompt: str):
        ...
        5. "meals_detail": (Array of Objects) Danh sách chi tiết từng bữa ăn được yêu cầu. Nếu người dùng đưa ra yêu cầu chung (không chỉ định riêng bữa nào), hãy gán yêu cầu đó vào tất cả các bữa ăn được nhắc đến. Mỗi object bao gồm:
...
if __name__ == "__main__":
    parser = LLMParser()
    print(parser.JSON_response("Tôi muốn tìm nhà hành siêu cay ăn sáng, trưa, tối. Kinh phí 2 triệu rưỡi. Buổi tối phải là nhà hàng âu, có không khí lãng mạn"))
